...
CONFIG_MANUAL = {
    ...
    "Notificacoes Ativas": {
        ...
        "TICKET_NOTIFICATION_RETRY_DELAY_SECONDS": "Atraso antes de tentar novamente um chamado que falhou na leitura do GLPI.",
        "TICKET_NOTIFICATION_TERMINAL_STATUSES": "Status GLPI que encerram a observacao do chamado, normalmente 5=solucionado e 6=fechado.",
        "TICKET_NOTIFICATION_BACKFILL_ENABLED": "Ativa recuperacao controlada de chamados recentes de usuarios vinculados quando o monitor esteve desligado.",
        "TICKET_NOTIFICATION_BACKFILL_INTERVAL_SECONDS": "Intervalo minimo entre varreduras leves de backfill.",
        "TICKET_NOTIFICATION_BACKFILL_USER_LIMIT": "Numero maximo de usuarios vinculados consultados por rodada de backfill.",
        "TICKET_NOTIFICATION_BACKFILL_TICKETS_PER_USER": "Numero maximo de chamados recentes analisados por usuario no backfill.",
