...
def render_impact_menu() -> str:
    return (
        ...
        "1. Apenas uma dúvida ou pedido simples.\n"
        "2. Consigo trabalhar, mas com dificuldades.\n"
        "3. Não consigo trabalhar por causa disso.\n"
        "4. Afeta várias pessoas ou um setor inteiro.\n\n"
